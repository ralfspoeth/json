...
class QueriesTest {
    ...
    void testIntValue() {
        assertAll(
                () -> assertEquals(1, intValue(new JsonDouble(1), 0)),
                () -> assertEquals(1, intValue(new JsonDouble(1.1d), 0)),
    ...
    void testLongValue() {
        assertAll(
                () -> assertEquals(1L, longValue(new JsonDouble(1), 0)),
                () -> assertEquals(1L, longValue(new JsonDouble(1.1d), 0)),
    ...
    void testDoubleValue() {
        assertAll(
                () -> assertEquals(1d, doubleValue(new JsonDouble(1), 0)),
                () -> assertEquals(1.1d, doubleValue(new JsonDouble(1.1d), 0)),
    ...
    void testStringValue() {
        assertAll(
                ...
                () -> assertEquals("1.0", stringValue(new JsonDouble(1d), null)),
                () -> assertEquals("1.1", stringValue(new JsonDouble(1.1d), null)),
                () -> assertEquals("1.123", stringValue(new JsonDouble(1.123d), null)),
